...
const habilidades = ref([
    ...
    } ,
    {
        ...
        { id: 3, nombre: 'Cypress', nivel: 'Avanzado', icono: '/src/components/icons/cypress.svg' },
        { id: 4, nombre: 'Figma', nivel: 'Intermedio', icono: '/src/components/icons/figma.svg' },
        { id: 5, nombre: 'Visual Studio Code', nivel: 'Intermedio', icono: '/src/components/icons/visual.svg' }
        ]
    },
    {
        id: 4,
    ...
    },
    {
        ...
        { id: 2, nombre: 'Ingles', nivel: 'Intermedio', icono: '/src/components/icons/eeuu.svg' }
        ]
    }
]);
</script>
